package com.expensetracker.userservice.entities.db;

import com.expensetracker.userservice.entities.model.UserPreferences;
...
public class ExpenseTrackerBean {
  ...
  public static class ExpenseTrackerBeanBuilder {
    ...
    public ExpenseTrackerBeanBuilder withPreferences(UserPreferences preferences) {
      expenseTrackerBean.setPreferences(preferences);
      return this;
    }
